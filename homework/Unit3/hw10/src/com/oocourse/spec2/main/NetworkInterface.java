...
public interface NetworkInterface {
    ...
    /*@ public normal_behavior
      ...
      @                                           accounts.get(accountId).ownerId != personId;
     */
    public /*@ safe @*/ void deleteOfficialAccount(int perssonId, int accountId) throws PersonIdNotFoundException, OfficialAccountIdNotFoundException, DeleteOfficialAccountPermissionDeniedException;
